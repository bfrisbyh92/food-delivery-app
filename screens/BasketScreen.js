  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      <View className="flex-1 bg-gray-100">
        <View className="p-5 border-b border-[#87CEEB] bg-white shadow-xs">
          <View>
          ...
          >
            <XCircleIcon color="#87CEEB" height={50} width={50} />
          </TouchableOpacity>
        </View>
        ...
        <ScrollView className="divide-y divide-gray-200">
          {Object.entries(groupItemsInBasket).map(([key, items]) => (
            ...
            >
              <Text className="text-[#87CEEB]">{items.length} x</Text>
              <Image
              ...
              >
                <Text className="text-[#87CEEB] text-xs">Remove</Text>
              </TouchableOpacity>
            </View>
          ))}
        </ScrollView>
